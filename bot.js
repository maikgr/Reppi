...
function generateImage(){
  ...
  images("input.jpg")
    ...
    .draw(images(__dirname + "/images/" + resultArray[1]) .size(160,160), 372, 386)
    .draw(images(__dirname + "/images/" + resultArray[2]) .size(160,160), 567, 386)
    .draw(images(__dirname + "/images/" + resultArray[3]) .size(160,160), 760, 386)
    .draw(images(__dirname + "/images/" + resultArray[4]) .size(160,160), 950, 386)
    .draw(images(__dirname + "/images/" + resultArray[5]) .size(160,160), 174, 576)
    .draw(images(__dirname + "/images/" + resultArray[6]) .size(160,160), 372, 576)
